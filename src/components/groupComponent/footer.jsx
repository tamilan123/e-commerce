        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-3 md:gap-8 py-10 max-sm:max-w-sm max-sm:mx-auto gap-y-8">
          <div className="col-span-full mb-10 lg:col-span-1 lg:mb-0">
            <a href="https://pagedone.io/"  className="flex justify-center lg:justify-start">
              <span className='text-black text-2xl font-bold'>New E</span>
            </a>
            ...
            <a href="/"  className="py-2.5 px-5 h-9 block w-fit bg-black rounded-full shadow-sm text-xs text-white mx-auto transition-all  duration-500 hover:bg-indigo-700 lg:mx-0">
                Contact us
            </a>
          </div>
          ...
          <div className="lg:mx-auto text-left ">
            ...
            <ul className="text-sm  transition-all duration-500">
              <li className="mb-6"><a href="/"  className="text-gray-600 hover:text-gray-900">My Account</a></li>
              <li className="mb-6"><a href="/"  className=" text-gray-600 hover:text-gray-900">Cart</a></li>
              <li className="mb-6"><a href="/"  className=" text-gray-600 hover:text-gray-900">Wishlist</a></li>
              <li><a href="/"  className=" text-gray-600 hover:text-gray-900">Product Compare</a></li>
            </ul>
          </div>
          ...
          <div className="lg:mx-auto text-left col-span-full lg:col-span-2">
            <h4 className="text-lg text-gray-900 font-medium mb-7">Let's Get In Touch</h4>
            <p className='m-0 text-gray-600 text-md'>Subscribe to our newsletter to receive news on update.</p>
            <div>
              <div className="relative mt-2 flex gap-3 rounded-md shadow-sm">
                <input
                  id="sub_email"
                  name="email"
                  type="email"
                ...
                />
                <button className='py-2.5 px-5 h-9 block w-fit bg-black rounded-lg shadow-sm text-xs text-white mx-auto transition-all  duration-500 hover:bg-indigo-700 lg:mx-0'>
                  Subcribe
                </button>
              </div>
            </div>
        ...
        <div className="py-7 border-t border-gray-200">
            <div className="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
                ...
                <div className="flex mt-4 space-x-4 sm:justify-center lg:mt-0 ">
                    <a href="/"  className="w-9 h-9 rounded-full bg-black flex justify-center items-center hover:bg-gray-600">
